...
export function PersonnelImport({ onImportComplete, user }: PersonnelImportProps) {
  ...
  const importData = async () => {
    ...
    try {
      ...
      console.log('✅ Session verified for Personnel CSV import')
      ...
      for (let i = 0; i < rows.length; i++) {
        ...
        try {
          // Personel Adı - tüm olası sütun isimleri (KÜÇÜK-BÜYÜK HARF DAHİL)
          let personnelName = (
            row['Personel Adı'] ||
            row['Personel Adi'] ||
            row['PersonelAdi'] ||
          ...
          if (!personnelName || personnelName.toLowerCase() === 'nan' || personnelName.toLowerCase() === 'null') {
            errors.push(`Satır ${i + 2}: Personel adı eksik`)
            failedCount++
            continue
          }
          ...
          const personnelData = {
            name: personnelName,
            role: 'cleaner', // Default olarak temizlikçi
            contactInfo: {
              phone: phone
            },
            tcNo: tcNo,
      ...
      if (successCount > 0) {
        toast.success(`${successCount} personel başarıyla eklendi!`)
        onImportComplete()
      }
    ...
    <>
      ...
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Personel CSV İçe Aktarma</DialogTitle>
          </DialogHeader>
          ...
          <div className="space-y-6">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-2">
                    ...
                    <ul className="text-sm text-blue-700 list-disc list-inside space-y-1">
                      <li><strong>personel adi</strong> veya <strong>Personel Adı</strong> (zorunlu)</li>
                      <li><strong>telefon</strong> veya <strong>Telefon Numarası</strong></li>
                      <li><strong>tc kimlik no</strong> veya <strong>TC No</strong></li>
                    </ul>
                    <div className="pt-2 border-t border-blue-300 mt-3">
                      <a 
                        href="/personel_ornek.csv" 
                        download="personel_ornek.csv"
                    ...
                    <p className="text-xs text-blue-600">
                      💡 Büyük-küçük harf fark etmez (personel adi = Personel Adı)
                    </p>
                    <p className="text-xs text-blue-600">
                      💡 Tüm personeller otomatik olarak "Temizlikçi" rolü ile eklenir
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            {/* File Upload */}
            <div className="space-y-2">
              <Label htmlFor="personnel-csv-file">CSV Dosyası Seçin</Label>
              <div className="flex gap-2">
                <input
                  id="personnel-csv-file"
                  type="file"
                  accept=".csv"
